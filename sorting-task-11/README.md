...
2) Navigate into your newly created repository and start writing.
    - Implement the selection sort, insertion sort, and merge sort.
...
Because your solution can be implemented using any language, write in a README file of how to build and run your application (that includes how to run the unit tests and your frontend).
